...
You've done very well to find a placement during a year when graduate application ratios hit a record high of `140:1`. This means that in 2024 the average _graduate_ vacancy had 140 applicants, with similar ratios for placement year applicants. [@ratio]  This confirms what you've probably already found out in your job hunting. It is an incredibly tough job market for _everyone_ at the moment and that includes students seeking employment through:
...
Obtain and submit plans for formal academic approval of your placement are at the end of your **second year** of undergraduate study, deadline **31 August 2025**, see section \@ref(basic)
...
The `(Hons)` in your `BSc (Hons) Computer Science with Industrial Experience` comes from your **Honours Project**, aka 3rd year (or final year) project. In April/May of your placement year you will need to either: 
...
You'll get an email about this from [Terence Morley](https://research.manchester.ac.uk/en/persons/terence.morley), make your project selections or propose an own project early **April/May 2026**.
...
1. The Department of Computer Science, see figure \@ref(fig:csreputation-fig) 
1. The University of Manchester, see figure \@ref(fig:mancreputation-fig)
1. Both your fellow students and future students at the University
...
```{r csreputation-fig, echo = FALSE, results='hide', message=FALSE, warning=FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:iebig)"}
