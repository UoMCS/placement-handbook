# Employers responsibilities to Industrial Experience students {#employers}
...
(ref:captionemployers) A panoramic picture of a sunny day on the Oxford Road with the [Kilburn Building](https://en.wikipedia.org/wiki/Kilburn_Building) on the right of the picture.
...
```{r gov-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap = "(ref:captiongov)"}
