...
* Duncan Hull (Employability lead, Computer Science) [manchester.ac.uk/staff/duncan.hull/contact](https://personalpages.manchester.ac.uk/staff/duncan.hull/contact), see figure \@ref(fig:team-fig)
* David Petrescu (Industrial Experience tutor, Computer Science) [manchester.ac.uk/en/persons/david-petrescu](https://research.manchester.ac.uk/en/persons/david-petrescu),  see figure \@ref(fig:team-fig)
...
```
(ref:captionteam) Duncan Hull (employability lead for Computer Science) and David Petrescu (Industrial Experience tutor)
