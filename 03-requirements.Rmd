...
1. You find a suitable placement. Help is available from academic staff, your peers and the careers service, but it is your responsibility to find a job. We will help you but you'll need to help yourself too, see section \@ref(finding)
1. You should be registered on IE, this may require that you change degree program. Bachelors students can change onto and off IE any point up until the end of your by filling in the change of degree form at [bit.ly/change-of-degree-form](https://bit.ly/change-of-degree-form) [@changedegree]
1. You have received a job offer and make an application for IE via My Placement [studentmobility.manchester.ac.uk](https://studentmobility.manchester.ac.uk)  [@myplacement]
...
1. You will need to attend any job interviews, assessment centres etc on-line or in person, sometimes multiple rounds, that you are invited to. You'll need to be resilient and get used to *lots* of rejection, which is a normal part of job searching for most people.
