...
(ref:captionrothwell) A panoramic picture of the Queen's Arch and the [Whitworth Building](https://en.wikipedia.org/wiki/Whitworth_Building) in Manchester. Many students do their Industrial Experience in Manchester, see [git.io/manc](https://git.io/manc) [@manc]. Most students work in the UK where London is often the most popular destination for IE. If you'd like to, it is possible to work _outside_ the UK provided certain conditions are met. Those conditions are outlined in this chapter.
...
To work outside the UK, **YOU** (and your employer) will need to sort out an appropriate visa that allows you to work in that country. For example, working the USA requires a [J-1 visa](https://en.wikipedia.org/wiki/J-1_visa) - you’d need to find a sponsor. Depending on your nationality and the country you'd like to work in, visa sponsorship *may* be available from organisations such as:

* [bunac.org](https://bunac.org)
* [istplus.com](https://istplus.com)
* [interexchange.org](https://www.interexchange.org)
* Engineers Without Borders [ewb-uk.org](https://www.ewb-uk.org)
* The International Association for the Exchange of Students for Technical Experience [iaste.org](https://iaeste.org)
