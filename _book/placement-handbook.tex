...
We often get asked if teaching materials are available in \href{https://en.wikipedia.org/wiki/Light-on-dark_color_scheme}{dark mode}. The good news is that this handbook \textbf{is} available in dark mode if you're reading this in a web browser, see figure \ref{fig:darkmode-fig}.
...
\caption{If you'd prefer to read this handbook in \href{https://en.wikipedia.org/wiki/Light-on-dark_color_scheme}{light on dark colour scheme}, move your mouse to the \texttt{A} at the top of the screen and select \texttt{Night} as shown circled in red here. Dark mode works in the web browser only, not the \href{https://placement-handbook.cs.manchester.ac.uk/placement-handbook.pdf}{pdf} or \href{https://placement-handbook.cs.manchester.ac.uk/placement-handbook.docx}{word} version.}\label{fig:darkmode-fig}
\end{figure}
