...
\hypersetup{
  ...
  pdfauthor={edited by Duncan Hull, David Petrescu and the School of Engineering placements team},
  hidelinks,
...
\date{DRAFT version currently under revision, last updated on 09 June, 2025}
...
\addcontentsline{toc}{chapter}{Welcome to Industrial Experience (IE)}
...
\caption{A panoramic picture of the \href{https://en.wikipedia.org/wiki/Nancy_Rothwell_Building}{Nancy Rothwell Building}, home to the \href{https://www.se.manchester.ac.uk/about/schools-and-departments/school-of-engineering/}{School of Engineering} at the University of Manchester}\label{fig:engineering-fig}
\end{figure}
...
\tightlist
\item
  \textbf{Duncan Hull}: Employability lead and employability tutor, Computer Science \href{https://personalpages.manchester.ac.uk/staff/duncan.hull/contact}{manchester.ac.uk/staff/duncan.hull/contact}, see figure \ref{fig:team-fig}
\item
...
\section{Industrial Experience in dark mode}\label{darkmode}

We often get asked if teaching materials are available in \href{https://en.wikipedia.org/wiki/Light-on-dark_color_scheme}{dark mode}. The good news is that unlikely some other course materials, this handbook \textbf{is} available in dark mode. If you're reading this in a web browser, you can choose whatever mode you prefer, see figure \ref{fig:darkmode-fig}.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{images/darkmode} 

}

\caption{If you'd prefer to read this handbook in a \href{https://en.wikipedia.org/wiki/Light-on-dark_color_scheme}{light on dark colour scheme}, move your mouse to the \texttt{A} at the top of the screen and select \texttt{Night} as shown circled in red here. Dark mode works in the web browser only, not the \href{https://placement-handbook.cs.manchester.ac.uk/placement-handbook.pdf}{pdf} or \href{https://placement-handbook.cs.manchester.ac.uk/placement-handbook.docx}{word} version.}\label{fig:darkmode-fig}
\end{figure}
...
\item
  ...
  \item
    the \href{https://placement-handbook.cs.manchester.ac.uk}{placement-handbook.cs.manchester.ac.uk}, all the \texttt{*.html} files you see if you are reading this text in a web browser
  \end{itemize}
\item
  Clone or fork the repository \href{https://github.com/uomcs/placement-handbook}{github.com/uomcs/placement-handbook}, make changes and submit a pull request
\item
...
\caption{Hello and welcome from Duncan Hull (left) employability lead and employability tutor for the Department of Computer Science and David Petrescu (right) Placement year tutor for your Industrial Experience, our contact details are shown in section \ref{team}}\label{fig:team-fig}
\end{figure}
...
\caption{Industrial Experience (IE) is an entrance way to new opportunities provided by your employer to develop skills and knowledge in the workplace. Panoramic picture of entrances and the Queen's Arch of the \href{https://en.wikipedia.org/wiki/Whitworth_Building}{Whitworth Building} at the University of Manchester}\label{fig:intro-fig}
\end{figure}
...
\tightlist
\item
  You find a suitable placement. Help is available from academic staff, your peers and the careers service, but it is your responsibility to find a job. We will help you but you'll need to help yourself too, see section \ref{finding}
\item
...
\item
  You have received a job offer and make an application for IE via My Placement \href{https://studentmobility.manchester.ac.uk}{studentmobility.manchester.ac.uk} \citep{myplacement}
\item
...
\section{Finding a placement}\label{finding}
...
\item
  You will need to attend any job interviews, assessment centres etc on-line or in person, sometimes multiple rounds, that you are invited to. You'll need to be resilient and get used to \emph{lots} of rejection, which is a normal part of job searching for most people.
\item
...
To work outside the UK, \textbf{YOU} (and your employer) will need to sort out an appropriate visa that allows you to work in that country. For example, working the USA requires a \href{https://en.wikipedia.org/wiki/J-1_visa}{J-1 visa} - you'd need to find a sponsor. Depending on your nationality and the country you'd like to work in, visa sponsorship \emph{may} be available from organisations such as:

\begin{itemize}
\tightlist
\item
  \href{https://bunac.org}{bunac.org}
\item
  \href{https://istplus.com}{istplus.com}
\item
  \href{https://www.interexchange.org}{interexchange.org}
\item
  Engineers Without Borders \href{https://www.ewb-uk.org}{ewb-uk.org}
\item
  The International Association for the Exchange of Students for Technical Experience \href{https://iaeste.org}{iaste.org}
\end{itemize}

There is more information from the careers service on working outside the UK at:
...
\item
  Treat you with respect. Although you are probably one of the most junior employees, you should not just be the office \href{https://en.wikipedia.org/wiki/Dogsbody}{dogsbody}, whose main responsbilities are making cups of tea and running errands for your colleagues.
\end{itemize}
...
\caption{A panoramic picture of the \href{https://en.wikipedia.org/wiki/Samuel_Alexander}{Samuel Alexander} Building from Burlington Street in Manchester.}\label{fig:burlington-fig}
\end{figure}
...
You've done very well to find a placement during a year when graduate application ratios hit a record high of \texttt{140:1}. This means that in 2024 the average \emph{graduate} vacancy had 140 applicants, with similar ratios for placement year applicants. \citep{ratio} This confirms what you've probably already found out in your job hunting. It is an incredibly tough job market for \emph{everyone} at the moment and that includes students seeking employment through:
...
Obtain and submit plans for formal academic approval of your placement are at the end of your \textbf{second year} of undergraduate study, deadline \textbf{31 August 2025}, see section \ref{basic}
...
The \texttt{(Hons)} in your \texttt{BSc\ (Hons)\ Computer\ Science\ with\ Industrial\ Experience} comes from your \textbf{Honours Project}, aka 3rd year (or final year) project. In April/May of your placement year you will need to either:
...
You'll get an email about this from \href{https://research.manchester.ac.uk/en/persons/terence.morley}{Terence Morley}, make your project selections or propose an own project early \textbf{April/May 2026}.
...
\tightlist
\item
  The Department of Computer Science, see figure \ref{fig:csreputation-fig}
\item
  The University of Manchester, see figure \ref{fig:mancreputation-fig}
\item
  Both your fellow students and future students at the University
\end{enumerate}
...
{\centering \includegraphics[width=1\linewidth]{placement-handbook_files/figure-latex/csreputation-fig-1} 

}

\caption{The Department of Computer Science has the biggest elective program of Industrial Experience (IE) at the University of Manchester. The chart shows the number of students starting an Industrial Experience placement year in 2024 as part of their undergraduate study at the University of Manchester. The data is plotted by Department: \texttt{CS}: Department of Computer Science \href{https://www.cs.manchester.ac.uk/}{cs.manchester.ac.uk}, \texttt{MACE}: Department of Mechanical, Aerospace and Civil Engineering (MACE) \href{https://www.mace.manchester.ac.uk/}{mace.manchester.ac.uk}, \texttt{EEE}: Department of Electrical and Electronic Engineering \href{https://www.eee.manchester.ac.uk/}{eee.manchester.ac.uk}, \texttt{ChemEng}: Department of Chemical Engineering \href{https://www.ce.manchester.ac.uk/}{ce.manchester.ac.uk}, \texttt{Chemistry}: Department of Chemistry \href{https://www.chemistry.manchester.ac.uk/}{chemistry.manchester.ac.uk}, \texttt{Maths}: Department of Mathematics \href{https://www.maths.manchester.ac.uk}{maths.manchester.ac.uk}, \texttt{Physics}: Department of Physics \& Astronomy \href{https://www.physics.manchester.ac.uk}{physics.manchester.ac.uk}, \texttt{Materials}: Department of Materials \href{https://www.materials.manchester.ac.uk/}{materials.manchester.ac.uk}, \texttt{EES}: Department of Earth and Environmental Sciences \href{https://www.ees.manchester.ac.uk/}{ees.manchester.ac.uk}. Data from PowerBI as of 2025, note that summer internships are shown in this bar chart, only year long placements.}\label{fig:csreputation-fig}
\end{figure}



So you're not just an ambassador for the Department, you're an ambassador for the University too.
...
\caption{According to \href{https://www.highfliers.co.uk}{highfliers.co.uk}, the University of Manchester has a good reputation with employers is one of the most highly targeted UK Universities by the \href{https://www.top100graduateemployers.com}{Times Top 100 Graduate Employers} \citep{highfliers2024}}\label{fig:mancreputation-fig}
\end{figure}
...
After the intial check-in(s) meeting(s) described in section \ref{tutor}, the main placement meeting is for you to meet the student and their manager and review their progress up to that point.

\section{Purpose of the manager, tutor, tutee meeting}\label{purpose}
...
\item
  Record that the meeting has taken place, using the \href{https://bit.ly/placement-visit-form}{bit.ly/placement-visit-form} \citep{visitform}
\item
...
Once you've visited your tutees, please fill in the short tutees form at \href{https://bit.ly/placement-visit-form}{bit.ly/placement-visit-form} \citep{visitform} to capture this information and so that we know which students have been visited. The meetings usually last somewhere between 15 and 30 minutes, we've a suggested agenda below.
...
The Careers Service offers support and advice throughout your time at the University of Manchester to help you make the most of your time here and best prepare you for your future. They can also advise you about your placement and career plans, see figure \ref{fig:careers-fig}.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{images/careers-service} 

}

\caption{The careers service offers a wide variety of support to you before, during and after your placement year, see \href{https://www.careers.manchester.ac.uk}{www.careers.manchester.ac.uk} \citep{careers}}\label{fig:careers-fig}
\end{figure}



For students interested in international placements see chapter \ref{notuk}. Careers service consultants for the University are listed online. \citep{consultants}
