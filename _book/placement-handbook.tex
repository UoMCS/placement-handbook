...
\date{DRAFT version currently under revision, last updated on 02 June, 2025}
...
\caption{Hello and welcome from Duncan Hull (left) employability lead, pre placement tutor for the Department of Computer Science and David Petrescu (right) On Placement year tutor for your Industrial Experience, our contact details are shown in section \ref{team}}\label{fig:team-fig}
\end{figure}
...
After the intial check-in(s) meeting(s) described in section @ref()
