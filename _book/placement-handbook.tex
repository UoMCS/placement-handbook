...
{\centering \includegraphics[width=1\linewidth]{images/engineering} 
...
\tightlist
\item
  Edit the \url{placement-handbook.docx} file, make sure you turn on \href{https://support.microsoft.com/en-gb/office/track-changes-in-word-197ba630-0f5f-4a8e-9a77-3712475e806a}{track changes in Microsoft Word} so other editos can see your changes. Please note, the images do not render well in the word document so it should only be used for editing text (not images or their captions)
\end{itemize}
...
\caption{Hello and welcome from Duncan Hull (left) employability lead for the Department of Computer Science and David Petrescu, Placement year tutor for your Industrial Experience.}\label{fig:team-fig}
\end{figure}
...
\caption{A panoramic picture of the Queens Arch and \href{https://en.wikipedia.org/wiki/Whitworth_Building}{Whitworth Building} at the University of Manchester}\label{fig:intro-fig}
\end{figure}
...
\caption{A panoramic picture of Waterloo Place on the Oxford Road in Manchster}\label{fig:aims-fig}
\end{figure}
...
It is possible to do a placement year outside the uk, these are described i the next section, chapter \ref{notuk}.
...
{\centering \includegraphics{images/rothwell} 

}

\caption{A panoramic picture of the \href{https://en.wikipedia.org/wiki/Nancy_Rothwell_Building}{Nancy Rothwell Building}, home to the School of Engineering at the University of Manchester.}\label{fig:rothwell-fig}
\end{figure}
...
\caption{A panoramic picture of a sunny day on the Oxford Road with the \href{https://en.wikipedia.org/wiki/Kilburn_Building}{Kilburn Building} on the right of the picture.}\label{fig:emloyers-fig}
\end{figure}
...
\caption{You got on your bike \citep{tebbit}, now your job is to ride it somewhere interesting with the help of your colleagues. A panoramic picture Starling Bank Bikes available for hire from \href{https://beeactive.tfgm.com/cycle-hire/}{beeactive.tfgm.com/cycle-hire}}\label{fig:onyerbike-fig}
\end{figure}
...
Most students \textbf{meet} or \textbf{exceed} the expectations of their employers. We want to help you achieve this while avoiding the first scenario and pointing you to help and advice if you think you might be startin to (or you actually are) struggling on placement.
