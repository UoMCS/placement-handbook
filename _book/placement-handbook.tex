...
\section{Academic leads}\label{leads}
...
\caption{Industrial Experience is your entrance to new opportunities in the workplace. A panoramic picture of the Queen's Arch and entrances to the \href{https://en.wikipedia.org/wiki/Whitworth_Building}{Whitworth Building} at the University of Manchester}\label{fig:intro-fig}
\end{figure}
...
\caption{A panoramic picture of the Queen's Arch and the \href{https://en.wikipedia.org/wiki/Whitworth_Building}{Whitworth Building} in Manchester. While many studnets work in Manchester, and most stay in the UK, it is possible to work outside the UK provided certain conditions are met, outlined in this chapter.}\label{fig:rothwell-fig}
\end{figure}
...
If you're not working in the UK you'll need to familiarise yourself with your rights and responsibilities as an employee, see chapter \ref{notuk}

\chapter{University responsibilities to studnets on Industrial Experience}\label{university}
