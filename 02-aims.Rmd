...
```{r aims-fig, echo = FALSE, fig.align = "center", fig.cap = "(ref:captionaims)", out.width = "100%"}
knitr::include_graphics("images/waterloo.jpg")
```

(ref:captionaims) Understanding the aims of Industrial Experience will help you get the most of out the year. Your placement year shouldn't be like the [Battle of Waterloo](https://en.wikipedia.org/wiki/Battle_of_Waterloo) but it should be an opportunity for you to learn and grow as a professional. Panoramic picture of Waterloo Place on the Oxford Road in Manchester
...
The workplace is different. You will probably spend a significant amout of time collaborating with more diverse teams of people than you did at University. This means that professional skills, sometimes called [soft skills](https://en.wikipedia.org/wiki/Soft_skills) , are important such as:

* Teamwork [@soft]
* Leadership [@transferable]
* Adaptability [@professionalism]
* Negotiation [@verbalising]
* Communication: 
    + Reading [@reading]
    + Writing [@writing]
    + Speaking [@speaking]
...
## Audit your professional skills {#audit}
...
(ref:captionskillsaudit) The skills audit you complete at the beginning and end of your placement will help you track your progress during your Industrial Experience year. The audits will also develop your self-awareness and better articulate what you have to offer to prospective employer in the future, find out more at [www.careers.manchester.ac.uk/options/skills/myskills](https://www.careers.manchester.ac.uk/options/skills/myskills/) [@audit]
...
## Recording your professional development {#development}
