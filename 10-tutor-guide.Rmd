# Tutor Guide for Industrial Experience Visits {#tutors}
...
```{r computerscience-fig, echo = FALSE, fig.align = "center", fig.cap = "(ref:captioncomputerscience)", out.width = "100%"}
knitr::include_graphics("images/computerscience.jpg")
```

(ref:captioncomputerscience) A panoramic picture taken outside the Turing Lounge in the Kilburn Building at the University of Manchester.  
...
## Purpose of the manager, tutor, tutee meeting {#purpose}
The purpose of the meeting between you (the tutor), your tutee (the student) and their manager is to: 

1. Find out what the student has been doing, see section \@ref(what) 
...
1. Record that the meeting has taken place, using the [bit.ly/placement-visit-form](https://bit.ly/placement-visit-form) [@visitform]
...
Once you’ve visited your tutees, please fill in the short tutees form at [bit.ly/placement-visit-form](https://bit.ly/placement-visit-form) [@visitform] to capture this information and so that we know which students have been visited. The meetings usually last somewhere between 15 and 30 minutes, we've a suggested agenda below.
